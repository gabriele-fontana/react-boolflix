    ...
    return (
        <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div className="card h-100 bg-black text-white border-0 movie-card position-relative overflow-hidden shadow">
                ...
                <div className="card-info-overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center p-3 text-center bg-dark">
                    ...
                    <span className="badge bg-danger mt-3 align-self-center">FILM</span>
                </div>
            </div>
        </div>
    );
